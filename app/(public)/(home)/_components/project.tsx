...
export const Project = async () => {
    ...
    return (
        <section className="my-4 grid h-auto w-full grid-cols-2 gap-x-6 px-3 lg:grid-cols-3">
            <TitleSection
                title="progetti"
            ...
            <Link
                href={"/progetti"}
                className="my-10 flex w-full justify-center md:col-span-3"
            >
                <motion.button
                    initial={{ opacity: 0, y: 100 }}
                    whileInView={{ y: 0, opacity: 1 }}
