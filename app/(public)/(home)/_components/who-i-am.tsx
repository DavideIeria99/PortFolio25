                ...
                {WhoStory &&
                    WhoStory.map((el, _) => (
                        <motion.div
                            ...
                            key={_}
                            className="flex h-50 w-70 flex-col justify-center rounded-xl border-2 border-orange-200 bg-orange-300 shadow-2xl shadow-orange-300 outline-2 outline-orange-400 md:h-35 md:rounded-sm md:px-2"
                        >
